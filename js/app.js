function calculate(e) {
  ...
  result.innerHTML = `
    ...
    <p>  Stiches each Sleave: ${Math.round(stichesEachPart / 2)} </p>
    <p>  Stiches each Raglan line: ${raglanLine} (before and after the ${Math.round(stichesEachPart / 2)} sleave stiches each)</p>
